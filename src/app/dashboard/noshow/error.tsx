...
export default function NoShowError({
  reset,
}: {
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '50vh' }}>
      ...
      >
        ...
        <p style={{ fontSize: '14px', color: 'var(--v2-text-muted)', lineHeight: 1.5, marginBottom: '24px' }}>
          Recarga la pagina o vuelve a intentarlo.
        </p>
        <button onClick={reset} className="btn-v2-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          <RefreshCw size={16} />
          Reintentar
        </button>
      </div>
