    ...
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-[480px] w-full p-8 space-y-5">
        ...
        <div className="space-y-3">
          <div className="border-2 border-[var(--v2-primary)]/30 rounded-xl p-4 flex items-start gap-3">
            <div className="w-10 h-10 rounded-lg bg-[var(--v2-primary)]/10 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-[var(--v2-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="space-y-2 pt-2">
          <button
            ...
            disabled={loading}
            className="w-full bg-[var(--v2-primary)] hover:bg-[var(--v2-primary-deep)] disabled:opacity-60 text-white font-semibold py-2.5 px-5 rounded-lg transition-colors"
          >
