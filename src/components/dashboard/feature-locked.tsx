...
export function FeatureLocked({
  ...
  const fullMessage = clinicName
    ? `Hola, soy ${clinicName} y quiero activar ${featureName} en mi plan de Omuwan.`
    : `Hola, quiero activar ${featureName} en mi plan de Omuwan.`
  ...
  return (
    <div className="p-6 lg:p-8 flex items-center justify-center min-h-[60vh]">
      <div className="max-w-md w-full text-center space-y-6">
        {/* Lock icon */}
        <div className="mx-auto w-20 h-20 rounded-full bg-[var(--v2-primary)]/10 flex items-center justify-center">
          <svg
            className="w-10 h-10 text-[var(--v2-primary)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1.5}
        ...
        <div className="space-y-3">
          ...
          <span className="inline-block bg-[var(--v2-primary)] text-white text-sm font-medium px-3 py-1 rounded-full">
            {featureName}
          </span>
        ...
        <div className="flex flex-col gap-3">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[var(--v2-primary)] hover:bg-[var(--v2-primary-deep)] text-white font-medium px-5 py-2.5 rounded-lg transition-colors"
          >
          ...
          {clicked && (
            <p className="text-sm text-emerald-600 font-medium">
              Te contactaremos en menos de 2 horas para activarlo.
            </p>
          )}
          <Link
            href="/dashboard"
